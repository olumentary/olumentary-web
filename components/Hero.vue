  ...
  <section class="h-full bg-hero-background bg-cover bg-indigo-900 bg-blend-multiply bg-opacity-60">
    <div class="flex items-center h-full py-4 px-6 md:px-6 lg:px-12 xl:px-80">
      <div>
        ...
        <NuxtLink to="/contact"><button type="button" class="py-2 px-4 bg-indigo-400 text-gray-100 rounded shadow font-bold hover:bg-indigo-800">Contact</button></NuxtLink>
      </div>
    </div>
  </section>
</template>
